            ...
            <div className="right-frame-object-list">
                ...
                {selectedObject && <div className="right-selected-timing-card" key={`${currentFrameIndex}-${selectedObject.id}`}>
                    ...
                    {editorTab === "animation" && <div className="right-selected-panel">
                        <label className="wide">Animation style<select value={selectedAnimation.type || "none"} onChange={(e) => onUpdateFrameElementAnimation?.(currentFrameIndex, selectedObject.id, { type: e.target.value })}><option value="none">Static</option><option value="fadeIn">Fade in</option><option value="scaleIn">Scale in</option><option value="elasticPop">Elastic pop</option><option value="slideUp">Slide up</option><option value="draw">Draw line / arrow</option><option value="movingHead">Moving arrow head</option><option value="dataFlow">Data flow</option><option value="energyTrace">Energy trace</option><option value="arrivalPulse">Arrival pulse</option><option value="signalBeam">Signal beam</option><option value="typewriter">Typewriter</option><option value="countUp">Number count up</option><option value="arraySwap">Array swap</option><option value="highlightSweep">Highlight sweep</option><option value="pulseRing">Pulse ring</option></select></label>
