...
export async function preloadDrawingImages2D(elements = []) {
...
export function hitTest2D(element, x, y) {
...
export function drawElement2D(ctx, element, selected = false, renderOptions = {}) {
    if (!element) return;
